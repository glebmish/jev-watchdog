...
from jev_watchdog.core.stats import GlobalStats, SurfaceStats
...
def test_every_console_line_is_the_rendering_of_the_published_record():
    from jev_watchdog.display.printer import render_line
...
def test_long_messages_are_cut_in_the_record_but_not_in_the_log():
    from jev_watchdog.display.feed import Feed
    from jev_watchdog.display.printer import MESSAGE_LIMIT
