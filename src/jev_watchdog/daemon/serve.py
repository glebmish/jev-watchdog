...
from jev_watchdog.daemon.client import Client, Refused, Unreachable
from jev_watchdog.daemon.paths import private_dir, socket_path
...
def dashboard(socket: Path, printer: Printer, console: Console, **app_options) -> Foreground:
    ...
    from jev_watchdog.dashboard.tui import WatchdogApp  # textual is only needed by whoever looks
